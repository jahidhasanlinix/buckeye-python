...
from buckeyelabs.tools.computer import (
...
# Create Buckeye FastMCP instance
mcp = MCPServer(
    name="Buckeye Remote Browser Environment",
    instructions="""
...
async def initialize_environment(ctx):
    ...
    try:
        ...
        for attempt in range(max_retries):
            try:
                persistent_ctx = attach_context("/tmp/buckeye_ctx.sock")
