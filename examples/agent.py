...
• Uses `buckeyelabs.client.MCPClient` to connect to **any** MCP environment – local
  subprocess here, Docker or remote Buckeye in real scenarios.
• Sends a single tool call and prints the result.

Run `python examples/agent.py` → prints `3 + 4 = 7`.
"""
