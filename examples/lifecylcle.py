...
from buckeyelabs.agents.claude import ClaudeAgent
from buckeyelabs.agents.base import find_reward, find_content


async def main():
    # Wrap everything in trace to provide RUN_ID for the task
    with buckeyelabs.trace("Agent Lifecycle Demo"):
