...
This script lets you evaluate any Buckeye-compatible Task dataset with either
...
Prerequisites:
• `uv add buckeye-python`
• Set `BUCKEYE_API_KEY` in your env.
...
def parse_args() -> argparse.Namespace:  # type: ignore[valid-type]
    parser = argparse.ArgumentParser(
        description="Evaluate Buckeye datasets",
...
async def main() -> None:
    ...
    if args.verbose:
        ...
        logging.getLogger("buckeye.agents").setLevel(logging.INFO)
        logging.getLogger("buckeye.agents.base").setLevel(logging.INFO)
